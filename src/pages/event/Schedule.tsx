  ...
  return (
    <div className="grid grid-cols-1 gap-14 lg:grid-cols-12">
      <section aria-labelledby="programme" className="lg:col-span-7">
        <h2 id="programme" className="font-display text-2xl sm:text-[1.7rem]">Order of events</h2>
        ...
        {event.schedule.length === 0 ? (
          ...
          <ol className="relative mt-10 border-l-[3px] border-ink pl-8">
            {event.schedule.map((s) => (
              <li key={s.id} className="group relative pb-9 last:pb-0">
                <span className="absolute top-1 -left-[2.7rem] h-5 w-5 rounded-full border-[3px] border-ink bg-danfo" aria-hidden="true" />
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <p className="tabular font-sign text-3xl leading-none">{formatTime(s.time)}</p>
                  ...
                  <button
                    ...
                    className="grid h-10 w-10 shrink-0 place-items-center rounded-full text-ink-faint hover:bg-paper-2 hover:text-red"
      ...
      <section aria-labelledby="add-moment" className="lg:col-span-4 lg:col-start-9">
        <div className="rounded-lg border-2 border-ink bg-danfo-soft p-6">
          <h2 id="add-moment" className="font-display text-xl">Add a moment</h2>
